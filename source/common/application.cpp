...
int our::Application::run(int run_for_frames) {
    ...
    ///1/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    int ID = 1190223;
    float Red = (ID % 100) / 100.0f;
    float Green = (int(ID / 100) % 100) / 100.0f;
    float Blue = (int(ID / 10000) % 100) / 100.0f;
    glClearColor(Red, Green, Blue, 1);          // changes the colour used to clear screen
